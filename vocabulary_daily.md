...
1. character  [ /ˈkærəktər/]( )   *n.* 品质, 特性, 特色  **字符  符号  暗码，密码，代码**  in character 在性质上
...
4. quite   [/kwaɪt/]( )   *adv.* 完全地；整体地；十分地

5. **idiomatic**  [ /ˌɪdiəˈmætɪk/]( ) *adj.* 符合语言习惯的,成语的 
...
11. consequential  [ /ˌkɑːnsɪˈkwɛnʃl/]( ) *adj.* 作为结果的, 重要的 
    ...
    **consequence** [ /ˈkɑːnsɪkwɛns/]( )  *n.* 结果, 后果  重要(性), 重大 
...
21. precedence  [/ˈprɛsɪdəns/]( )   *n.* 领先于…的权利;优先权  
...
25. modification  [ /ˌmɑːdɪfɪˈkeʃn/]( )    so any modifications would be discarded   所以任何修改都会被丢弃 

26. agent-noun 代理名词 

27. productive [ /prəˈdʌktɪv/]( ) 
...
31. omit [/oˈmɪt/]( )   *vt.* 省略，遗漏；删掉 

32. **clause** [/klɔːz/]( )  子句 从句
...
42. pragmatism  [ /'prægmə'tɪzəm/]( )   n. 实用主义 
    ...
    **pragmatic**  [/præɡˈmætɪk/]()   *adj.* 务实的；实事求是的；注重实效的 
...
47. volatile [ /ˈvɑːlətl/]( )  在计算机中，volatile是一个关键字，用于修饰变量。它的作用是告诉编译器，该变量的值可能会在程序的执行过程中被意外地改变，因此编译器不能对该变量进行优化，必须每次都从内存中读取该变量的值。这样可以保证程序的正确性，但是会降低程序的执行效率。 
...
50. adorn  [/əˈdɔːrn/]( )  vt. 装饰；使生色 

    unadorned  [ /ˌʌnəˈdɔːrnd/]()   *adj.* 朴素的;未经装饰的 

51. exploit  [/ɪkˈsplɔɪt/]( )  vt. 利用  exploiting the fact  利用这一事实  
...
55. The fields of a composite literal are **laid** **out** in order and must all be present.  复合字词的字段是**按顺序**排列的，必须全部出现。 
    ...
    literal  [ /ˈlɪtərəl/]( )  "literal" 通常翻译为 "字面值"。在编程语言中，字面值是指直接表示自身的常量或数值，而不需要进行进一步解释或计算的值。字面值可以是数字、字符串、布尔值或其他数据类型的常量。它们在程序中直接使用，而不需要经过计算或处理。

    例如，在许多编程语言中，整数字面值 "123" 表示数值 123，字符串字面值 "Hello, World!" 表示包含该文本的字符串，布尔字面值 "true" 表示真值（True），等等。这些字面值在程序中被直接使用，而不需要额外的计算或操作。
...
59. afterward  [/ˈæftɚwɚd/]( )   *adv.* <美>以后, 过后, 后来 
...
64. **intricate**   [ /ˈɪntrɪkɪt/]( )   *adj.* 错综复杂的 

    *[intricate plot]( t)* 剧情复杂 

    The design is intricate  这个设计是错综复杂的 

65. **contrived** [ /kən'traɪvd/]( )  *adj.*   精心设计的 

    In this **contrived** example `Sequence` [/ˈsiːkwəns/]( ) satisfies **both**. 在这个设计好的例子中，Sequence同时满足了这两点 

66. **analogy**  [ /əˈnælədʒi/]() *n.* 类似, 相似  类比  
...
67. trivial [/ˈtrɪviəl/]( )  adj. 不重要的，琐碎的；琐细的 普通的
    ...
    **slip**   [/slɪp/]()   
    ...
    1. 滑倒："Slip" 可以指一个人或物体在表面上滑倒或失去平衡的动作或状态。例如，"He slipped on the icy pavement"（他在结冰的人行道上滑倒了）。
    2. 滑动："Slip" 也可以表示物体在表面上滑动或移动的动作。例如，"The book slipped out of my hand"（书从我的手中滑落）。
    3. 滑落："Slip" 还可以表示某物从一个位置或状态滑落或下滑。例如，"The letter slipped through the mail slot"（信件从邮槽滑落了）。
    4. 溜走："Slip" 在某些情况下可以表示偷偷溜走或逃脱。例如，"The thief managed to slip away before the police arrived"（小偷在警察到达之前设法逃脱了）。
    5. 错误："Slip" 还可用于指人在言语、行为或判断上犯下的错误或差错。例如，"I slipped and said the wrong name"（我失言说错了名字）。
    6. 逐渐减少或变小：在某些情况下，"slip" 还可用于表示逐渐减少、下降或变小。例如，"Sales have slipped in the past month"（销售额在过去一个月里有所下降）

68. harm  [ /hɑːrm/]( )   *n.* 损害, 危害, 伤害  *vt.* (使)受到损害, 伤害 

    *no harm* 无害 

    *out of harm's way* 在安全地带 

69. **irrelevant**  [ /ɪˈrɛləvənt/]( )  *adj.* 不相干的,不相关的 
...
71. *[workaround]( )*    [ /'wə:kə,raund/]( )  **n. 应变方法；变通方法，替代方法；对策**  *n.* 工作区

72. silence  [/'saɪləns/]( )  vt. 平息  *n.* 寂静；无声 

    To silence **complaints** about the unused imports, use a blank identifier to refer to a symbol from the imported package  为了平息对未使用的导入的抱怨，使用一个空白的标识符来指代导入包中的一个符号
...
77. regular 
    ...
    *regular polygon* 正多边形；正多角形 [ /'pɑlɪɡɑn/]( )

    *regular inspection* 定期检查 [/ɪnˈspɛkʃn/]( )
...
78. refine [/rɪˈfaɪn/]( )   vt. 精炼，提纯；使…文雅；改善 

    They refined gold out of the **ore**  他们从矿石中提炼出黄金  [/ɔːr/]( ) 

79. package **qualifier** 包修饰符  [/'kwɑlɪfaɪɚ/](  )  n. 限定词，限定语；取得资格的人；修饰语 
...
82. inaccurate  [/ɪn'ækjərɪt/]()   *adj.* 有错误的,不正确的 
...
90. **schematic** [ /skiːˈmætɪk/]( )   

    1. *adj.* 纲要的，图表的；示意的，概略的
    2. *n.* 图表，(尤指)电路原理图

91. **execution**  [ /ˌɛksɪˈkjuːʃn/]( ) 
...
3. unitary  [/'junɪtɛri/]()  adj. 单位的；单一的；统一的  unit  n. 单位

4. bypass   [ /ˈbaɪpæs/]()   *vt.* 绕过, 避开  *n.* 旁道   

   *bypass surgery* 绕道手术；心脏搭桥手术 

   Let's bypass the town  我们绕过这座小镇子吧 

5. **stochastic**  [ /sto'kæstɪk/]()  *adj.* 随机的 

   *stochastic process* 随机过程 

   *stochastic model* 随机模型；随机模式 

6. **exhaustive** [ /ɪɡˈzɔːstɪv/]( )   *adj.* 全面的, 彻底的, 透彻的 
...
8. **amplifier**  [ /ˈæmplɪfaɪər/]( )  *n.* 扩音器, 放大器 

   **amplitude**  [/'æmplɪ'tʊd/]( )  **振幅**
...
10. witness [/ˈwɪtnɪs/]( )  *n.* 目击者；证人  *vt.* 亲眼看见，目击 
...
16. **dilation**  [ /daɪˈleʃən/]()  n. 扩张，扩大；膨胀；详述  time dilation  时间膨胀 

17. **convolution**   [ /ˌkɑnvə'luʃən/]( ) *n.* 回旋,盘旋,卷绕 
...
1. recap  [ /ri'kæp/]( )  as a quick recap  快速复习一下 
...
4. **composition**   [ /ˌkɑːmpəˈzɪʃn/]( ) 
   ...
   **decomposition**  [ /ˌdiːˌkɑːmpəˈzɪʃn/]( )   *n.* 分解  腐烂 

5. **aisle**   [/aɪl/]( )  *n.* 过道, 通道 

6. **ideology** [/ˌaɪdiˈɑːlədʒi/]( )  n. 意识形态  

7. **representation**   [/ˌrɛprɪzɛnˈteʃn/]( ) 
   ...
   "expression"（表达）、"depiction"（描绘）或 "interpretation"（解释） 
   ...
   *data representation* 数据表示法 
   ...
   The painting is a powerful representation of the artist's emotions and experiences.  这幅画作是艺术家情感和经历的有力表达
...
8. **suppose**  [/sə'poz/]( ) 
   ...
   Eating spinach([/'spɪnɪtʃ/]( )) is supposed to make you strong  据说吃菠菜能使人强壮

   I suppose the meeting will be rescheduled.   我猜会议会被重新安排 

   Let's suppose for a moment that money is not an issue.   让我们假设一下，金钱不是问题
...
11. **convergence**  [ /kən'vɝdʒəns/]( )  *n.* 集中,收敛；集合 
...
12. **drowsiness**  [/ˈdraʊzɪnɪs/](  )  *n.* 睡意;假寐;困倦 

    *[drowsiness detection]( )* 疲劳检测  

13. **malformed**  [/ˌmæl'fɔrmd/]( )  *adj.* 难看的,畸形的 
...
2. **compiler**  [ /kəm'paɪlɚ/]( ) 编译器

3. dequeue [/di'kju:/]( )  vi. 出队列

4. enqueue [/ɪn'kjuː/]( )  vt. [计] 入队列 push 进栈 --- pop 出栈
...
12. **discrete**  [ /dɪˈskriːt/]()  *adj.* 分离的, 不相关联的  不连续的  

    *discrete mathematics* 离散数学  

    *discrete value* 不连续值，离散值 

13. **integrated circuit**  [ /ˈɪntɪˌɡretɪd/]( )   [ /ˈsɜːrkɪt/]( ) 集成电路 

14. **electronic**  [/ɪˌlɛkˈtrɑːnɪk/]( )  *adj.* 电子的; 电子器件的 
...
14. manner [ /ˈmænər/]() 
    ...
    **in a manner of speaking**   == In a way; so to speak  在某些方面；可以说 

    **to the manner born**  天生就习惯 

    She always speaks in a polite manner [ /pəˈlaɪt/]( ) 她总是以礼貌的方式说话

    His manner of talking sickens us [ /ˈsɪkən/]( )  我们真讨厌他那种讲话方式  

    She waved goodbye in a cheerful manner.   她以愉快的方式挥手告别

15. **observability**  [ /əb'zə:vəbiliti/]( )  n. [数] [计算机] 可观察性 

16. wipe out v. 消灭，彻底摧毁，擦掉
...
20. **disrupt** [ /dɪsˈrʌpt/]( )  *vt.* 使混乱, 扰乱 

    *[Telecommunications Disrupted]( )* 电信中断 

    The communication was disrupted by the storm  暴风雨使交通中断 

    And it is disrupting obviously [/ˈɑːbviəsli/]( ) day to day life  显然，这打乱了人们的日常生活 
...
- "Though"通常位于句子中或句尾，例如："I like him, though."（我喜欢他，虽然。）

- "Although"通常用作引导从句的连词，在从句的开头使用，例如："Although it was raining, we went for a walk."（虽然下雨了，我们还是去散步了。）

  格式：

- "Though"通常被用作简略形式，特别是在口语中，例如："I'm tired, though."（我累了，不过。）

- "Although"更常用于正式的写作和书面语中。

1. Through [/θru/ ](   )  prep.  adv. adj. （穿过，经过）- 这个词通常用来描述通过某个空间或完成某项任务。例如："We drove through the tunnel to get to the other side."
...
11. reserve  [ /rɪˈzɜːrv/]( )  *vt.* 保留[储备]某物  *n.* 贮藏；储备 
    ...
    *reserve capacity* 备用容量；备用能力；储备功率 [ /kəˈpæsəti/]( )
...
12. nominate [ /ˈnɑːmɪnet/]( )  vt. 提名；任命  指定；推荐 

13. **Comment** [/ˈkɑːmɛnt/]()（注释）是一种用于在代码中添加注释的方式，它不会被编译器或解释器处理或执行。注释通常用于解释代码的意图或目的，或者提供代码的上下文信息，以帮助其他程序员更好地理解代码。注释通常以特定的注释标记或符号（如 // 或 #）开头，并可以跨越一行或多行。

    **Annotation**  [ /ˌæno'teʃən/]( ) （注解）是一种给代码添加元数据的方式，它可以被编译器或解释器处理或执行。注解通常用于在代码中添加额外的信息，例如类型检查、性能分析或测试套件配置等。注解通常以特定的语法（如@annotationName）和参数列表的形式出现在代码中，并会被编译器或解释器在编译时处理。
...
16. *exclusive agency* 独家代理商  [ /ɪkˈskluːsɪv/]( )  *an exclusive right* 独占权  *exclusive news* n. 独家新闻  *exclusive distributor* 独家经销商 

17. **ephemeral**  [/ɪˈfɛmərəl/]( )  ( [temporary]( ))   == >  [permanent]( )   

    *[ephemeral apps]( )* 轻应用 

    *[ephemeral ports]( )* 临时端口 

18. The railway **traverses** the country   [/trəˈvɜːrs/]( )   这条铁路横贯全国 
...
8. **impersonate**   [ /ɪmˈpɜːrsənet/]( )    *vt.* 扮演   模仿, 假冒  
...
9. rigor  [/ˈrɪɡɚ/]( ) 
   ...
   The research study was conducted with rigor to ensure accurate and reliable results.  这项研究以严谨的方式进行，以确保结果的准确性和可靠性

   *[rigor chill]( )* 寒冷  [ /tʃɪl/]( )  *vt. & vi.* (使)变冷, (使)变凉  *n.* 寒冷, 寒气  寒颤, 发冷 

10. **residual**  [/rɪˈzɪdʒuəl/]( )  *adj.* 存留下来的;剩余的;残余的 
...
13. Prometheus ***comes with*** `PromQL`  普罗米修斯自带PromQL [prə'mi:θiə:s/]( ) 

14. depict   [/dɪˈpɪkt/]( )   *vt.* 描绘；描画  描述 

15. Please don’t hesitate to contribute to the repo for adding features.  请不要犹豫，为这个repo添加功能

    **hesitate**  [ /ˈhɛzɪtet/]( )    vi. 踌躇，犹豫；不愿   vt. 踌躇，犹豫；有疑虑，不愿意  
...
19. multi-tenancy 多租户
    ...
    **tenancy**  [ /'tɛnənsi/]( )   *n.* 租用, 租赁  租用或租赁期 

20. making it possible to operate Prometheus at scale with high availability.  使得Prometheus的规模化运维和高可用性成为可能。 
...
7. challenge incorrect **premise** 挑战错误的前提

   premise  [/ˈprɛmɪs/]( )  n. 前提；上述各项；房屋连地基  vt. 引出，预先提出；作为…的前提 
...
11. **potent**  [ /ˈpotnt/]( )   adj. 有效的；强有力的，有权势的；有说服力的 
    ...
    **potential**  [/pəˈtɛnʃl/]( )   *adj.* 潜在的, 有可能的  *n.* **潜力；电位；电势；可能性** 
    ...
    *potential impact* 潜在影响 
    ...
    He taught us that **potential** **vanishes** into nothing without **effort ** /ˈɛfərt/  他教导我们，没有努力，潜能便会消失得无影无踪 

    1. 描述力量和效力："Potent" 在这方面的含义是强大、有效的、有力的。它可以用来描述物理力量、化学反应的强度、药物的效力等。例如，"a potent punch"（一记有力的拳击）、"potent medicine"（有效的药物）。
    2. 描述影响力和影响力强大的人或事物："Potent" 可以用来形容有影响力、有重要性或有威力的人、组织或事物。例如，"a potent leader"（有影响力的领导者）、"a potent political party"（有力的政党）。
    3. 描述潜在的能力或潜力："Potent" 也可以表示具有潜在的能力或潜力。例如，"a potential solution"（潜在的解决方案）、"a potent source of innovation"（潜在的创新源）。
    4. 描述引起强烈感觉或反应的事物："Potent" 可以用于描述引起强烈感觉、情感或反应的事物。例如，"a potent aroma"（强烈的香味）、"a potent emotional experience"（强烈的情感体验）。

12. boilerplate [/'bɔɪlɚplet/]()  *n.* 样板文件   boilerplate code 样板代码
...
14. rendezvous  [ /'rɑndevʊ/]( )   *n.* 约会  约会的地点(和时间)  *vi.* 约会, 会合 
...
17. **dispatch**  [ /dɪˈspætʃ/]( )  n. 派遣；急件  vt. 派遣；[计算机]分派  **派送 分发**

    *economic dispatch* 经济调度；经济分配 

    *dispatch center* 调度中心；运输中心；勤务中心 

18. **dichotomy**  [ /daɪˈkɑːtəmi/]()  *n.* 一分成二,对分 

    *[dichotomy search]( )* 二分法查找 

19. **constraint**  [ /kənˈstrent/]( )  *n.* 强制；限制，约束 
...
20. **eligible**   [/ˈɛlɪdʒəbl/]( )    *adj.* 有资格当选的, 有条件被选中的   合适的, 适当的

    This man is an eligible leader   这人是一个合适的领导 

#### 009G

1. **bonkers**  [ /'bɑŋkɚz/]( )   *adj.* 疯狂的,精神不正常的 

   This event was bonkers, so let's check it out  这个事件很疯狂，让我们来看看
...
4. **legacy**  [ /ˈlɛɡəsi/]( )   *n.* 遗产, 遗赠物  遗留之物 
   ...
   cultural legacy  文化遗产  /ˈkʌltʃərəl/

5. **supercharge**  [ /ˈsjupɚˌtʃɑrdʒ/]()   *vt.* 对…增压   

   turbocharging /ˈtɜrbo ˌtʃɑrdʒɪŋ/  涡轮增压

   mechanical supercharging 机械增压 [/mɪˈkænɪkl/]( ) 
...
6. bleach   [/bliːtʃ/]( )  
   ...
   *chlorine bleach* 氯漂白；氯漂白剂    **[/'klɔrin/]( )** 

7. **contaminate**  [/kənˈtæmɪnet/]( )   *vt.* 把…弄脏, 污染 

   *[contaminated air]( )* [环境] 污染空气

8. **segmentation**  [ /ˌsɛɡmɛn'teʃən/]( )   *n.* 分割 
...
10. **initiative**  [ /ɪˈnɪʃətɪv/]( )   *n.* 主动性, 首创精神 
    ...
    ***subjective initiative* 主观能动性**
    ...
    subjective   /səbˈdʒɛktɪv/  adj. (思想、感情等)主观的
...
12. **descriptor**  [ /dɪ'skrɪptɚ/]( )  *n.* 描述符 
...
14. **preliminary**  [ /prɪˈlɪmɪnɛri/]( )  --->   **vantage**  [ /ˈvæntɪdʒ/]( )  ---> **higher** [ /'haɪɚ/]( )  
...
14. realtime 实际时间  adj. 实时的；适时的 
    ...
    *[realtime multitask]( )* 实时多任务

    *[realtime curve]( )* 实时曲线

    *[realtime display]( )* 实时显示
...
3. [material]( ) 通常指组成客观存在物的部分或其原料。
   [matter]( r) 通常指构成实物的物质，与精神相对立。在科学上，指占有空间，并能以某种方式被感官觉察的一切东西。
...
22. **excess**  [ /ɪkˈses/](cmd://Speak/_us_/excess)    n. 无节制；过度，过量；超过，超额  adj. 额外的，过量的；附加的 

    *excess profit* 超额利润

#### 014G

1. **perimeter**  [/pə'rɪmɪtɚ/](cmd://Speak/_us_/perimeter)   *n.* 周边;周围;边缘 

   The river marks the eastern **perimeter** of our land  这条河标示我们的土地东面的边界 

2. **inconvenience**  [ /ˌɪnkən'vinɪəns/](cmd://Speak/_us_/inconvenience) 

   1. *n.* 不方便, 麻烦, 打扰
   2. 不便之处, 麻烦事
   3. *vt.* 给…带来不便, 给…添麻烦, 打扰

   We have credited your account $500. We're sorry for the inconvenience  我们将五百块汇到你的账户 抱歉造成你的不便 

   Right, so those who are determined don't see obstacles as something that prevents success, but mere inconveniences that need to be overcome  对，所以那些有决心的人不会把障碍视为阻碍成功的东西，而只是需要克服的不便 

3. **chore**   [ /tʃɔːr/](cmd://Speak/_us_/chore) 

   1. 家庭生活中，如做饭、洗碗、清理房间、打扫卫生等。
   2. 工作场合中，如整理文件、清理办公桌、填写报告、打印文件等。
   3. 农村或农业领域中，如耕种、收割、除草、灌溉等。
   4. 日常生活中的琐碎事务，如购物、处理账单、整理衣物、修理家具等。

   I figured he should be doing a few chores  我觉得他应该分担些家务了 

4.  **ownership**  [/ˈoʊnərʃɪp/](cmd://Speak/_us_/ownership)  *n.* 物主的身份；所有(权)，所有制 
   ...
   *collective ownership* 集体所有制 
   ...
   Ice bear needs to see proof of ownership.  白熊想看一下所有权证明 

5.  troubleshooting  [ /'trʌbl,ʃu:tiŋ/](cmd://Speak/_us_/troubleshooting)  *n.* 发现并修理故障,解决纷争

6.  **preemption**  [ /ˌpriɛmpʃən/](cmd://Speak/_us_/preemption)   *n.* 先买权;先占;先发制人 

   *[Preemption Scheduling](dic://Preemption Scheduling)* 抢占式调度 

7. **walkthrough**  [ /wɔkθrʊ/](cmd://Speak/_us_/walkthrough) 

   1. 游戏开发：游戏开发人员通常会创建游戏的 "walkthrough"，以帮助玩家更好地理解游戏的流程，了解如何完成任务和挑战。
   2. 软件使用：在软件界面或应用程序中，"walkthrough" 通常指一系列指导用户如何使用软件或应用程序的步骤。这种类型的 "walkthrough" 可以帮助新用户更快地上手。
   3. 旅游行业：在旅游行业中，"walkthrough" 可能指导游，即一种由专业导游或自助旅游应用提供的虚拟导览，以帮助游客更好地了解目的地的历史、文化和景观。
   4. 建筑设计：在建筑设计中，"walkthrough" 是一种可视化技术，通常用于模拟用户在建筑物内部的移动路径。这种技术通常用于展示建筑物的设计和布局。

   "We offer a step-by-step walkthrough of the process to make it as simple as possible for our clients."

8. assume  [ /əˈsuːm/](cmd://Speak/_us_/assume) 

   [assume](dic://assume) 指有很少或完全无根据的武断推测或不合逻辑的推理。
   [presume](dic://presume) 侧重以过去经验或根据现实的某些感觉把某事认定为是事实。
   [suppose](dic://suppose) 常用词，意义较广泛，指缺乏确切事实，根据一些现象进行的推测，也可指为论证而提出合乎逻辑推理的某种假定，有时仅表示自己的意见。
   [guess](dic://guess) 常用词，指毫无根据仅凭个人主观臆断或碰运气的猜测。
   [postulate](dic://postulate) 指为证实一个理论的正确性而进行的假设。 

   I never **assumed** we were universally loved  我从来没想过人人都喜欢我们 

   I **assume** you talk to her, apologize.  你应该有去跟她谈谈、道歉吧 

   He assumed full authority as tsar in 2023  1689年他全面掌权做了沙皇  [ /zɑr/](cmd://Speak/_us_/tsar)  *n.* 俄国沙皇 

9. **periodic**  [ /ˌpɪriˈɑːdɪk/](cmd://Speak/_us_/periodic)  adj. 周期的，定期的 
...
10. oversubscription   [ /'ovɚsəb'skrɪpʃən/](cmd://Speak/_us_/oversubscription)    *n.* 认购超额 

    1. 计算机网络：在计算机网络中，oversubscription 通常指网络带宽或端口数量被过度订阅或使用，导致网络性能下降或中断。例如，一个交换机的总带宽可能是 10 Gbps，但它可能有 20 个 1 Gbps 的端口，因此如果所有端口都被同时使用，就会出现 oversubscription。
    2. 投资：在金融投资中，oversubscription 通常指投资者对某种投资机会或产品的需求超过了其可用的数量，导致某些投资者无法获得想要的份额或回报。例如，在 IPO 上市首日，某些股票可能会因为投资者的超额申购而 oversubscribed。
    3. 基础设施建设：在基础设施建设中，oversubscription 通常指某种公共设施或资源的需求超过了其可用的容量或资源，导致供需失衡或使用效率下降。例如，某个城市的地铁系统可能在高峰时间被过度订阅，导致拥挤、延误和安全问题。

    总的来说，oversubscription 这个单词在英语中通常指某种资源或服务被过度订阅或使用，超过了其实际可用的数量或容量。根据具体的应用场景不同，它可能有不同的含义和引申义。 

11. **compact**  [/ˈkɑːmpækt/](cmd://Speak/_us_/compact) 

    1. n. 合同，契约；小粉盒
    2. adj. 紧凑的，紧密的；简洁的
    3. vt. 使紧密结合；使简洁 

    France has reluctantly ratified the recent fiscal **compact**, which gives Brussels extra budgetary powers.  法国勉强同意了最近的政府财政条约，这给了Brussels额外的预算上的优势 

     Boston is a **compact** and highly livable city  波士顿不大，却是极为适合居住的城市 

    Volkswagen introduced its latest SUV Tuesday, while Cadillac's first **compact** SUV made its public debut  大众汽车周二推出了最新款SUV，凯迪拉克首款紧凑型SUV首次亮相 

12. **alleviate**   [/əˈliːvieɪt/](cmd://Speak/_us_/alleviate)   *vt.* 减轻, 缓解, 缓和  Heat often alleviates pain  热常常能减缓疼痛 

13. **bumpy**  [ /'bʌmpi/](cmd://Speak/_us_/bumpy)  adj. 崎岖不平的；颠簸的 \

    *[bumpy flight](dic://bumpy flight)* 不平稳的飞行；颠簸飞行 

    *[bumpy lading](dic://bumpy lading)* 颠簸着陆

14.  **capitalization**  [/ˌkæpɪtəlɪ'zeʃən/](cmd://Speak/_us_/capitalization)  *n.* 资本化,股本,资本总额,大写

    *market capitalization* [经]（股票等的）市值

    *capitalization rate* 资本化率

15. **convention**  [ /kənˈvenʃn/ ](cmd://Speak/_us_/convention) *n.* (某一职业、政党等的人士召开的)大会   习俗, 惯例   协议, 协定 

    *international convention* 国际惯例；国际公约；国际协定

    *convention center* n. 会议中心；会展中心

    Japan has signed a convention of peace with a neighboring country  日本已与邻国签署了一项和平协定 

16. ease [ /iːz/](cmd://Speak/_us_/ease) 

    1. vt. 减轻，缓和；使安心
    2. n. 安逸，悠闲；轻松，舒适
    3. vi. 减轻，缓和；放松；灵活地移动 

    easing the hostility between rich and poor  缓和贫富之间的矛盾 

    [comfort](dic://comfort) 通常指在摆脱烦人、痛苦的事情，或在要求、愿望得到满足后所感到的舒适。
    [ease](dic://ease) 指因没有担心和忧虑而轻松。
    [leisure](dic://leisure) 专指闲暇时间或悠闲状态。
    [relaxation](dic://relaxation) 强调消除肌肉疲劳或思想的紧张状态，使身心松弛，得到休息。
    [relief](dic://relief) 侧重有消除痛苦、不适或困难的负担，常暗含不利因素已不存在的意味。
    [rest](dic://rest) 与work相对，强调水分除身心痛劳，不着重休息方式。

17. *[ellipsis mark](dic://ellipsis mark)* 省略号  [ /ɪ'lɪpsɪs/](cmd://Speak/_us_/ellipsis)  n. 省略；省略符号；脱漏 

18.  **aptly** [/ˈæptlɪ/](cmd://Speak/_us_/aptly)   adv. 适宜地；适当地 

    Florida is aptly named the Sunshine State  称佛罗里达为阳光州再适合不过了 
...
19.  **lease**  [/liːs/](cmd://Speak/_us_/lease) 
    ...
    Do you lease out land?  你出租土地吗? 

20.  **In terms of** tropical storms, sure, **in terms of** hurricanes [/ˈhɜːrəkeɪn/](cmd://Speak/_us_/hurricane) , not even close  就热带风暴来讲，确实如此。而就飓风而言，完全不对或者至少不尽然 

    - *[In terms of syntax](dic://In terms of syntax)*  [ /'sɪntæks/](cmd://Speak/_us_/syntax) 在语法方面

    - *[In terms of lansign](dic://In terms of lansign)* 从语言符号上

    - *[In terms of thought](dic://In terms of thought)* 在思想方面

    **tropical**  [ /'trɑpɪkl/](cmd://Speak/_us_/tropical)  adj. 热带的；酷热的；热情的 

#### 015G

1. **hint**  [ /hɪnt/](cmd://Speak/_us_/hint) 
   ...
   **reshuffle** [ /ˈriːʃʌfl/](cmd://Speak/_us_/reshuffle)   *vt.* 对(某集体)作岗位或职责的调整,改组(某集团)  *vt. & vi.* 重新洗(牌)  *n.* 改组(尤指政治组织) 

   He hinted his dissatisfaction with her work. 他暗示了对她工作的不满 

2. **retailer**  [ /ˈriːteɪlər/](cmd://Speak/_us_/retailer)     零售商 

   *[online retailer](dic://online retailer)* 网络零售商; 线上零售商 

3. *[dispatcher](dic://dispatcher)*  [ /dɪsˈpætʃɚ/](cmd://Speak/_us_/dispatcher)  n. 调度员；[计] 调度程序；[计] 分配器    *n.* 调度员

   *[dispatcher program](dic://dispatcher program)* 调度器程式; 调度器程序; 

4. transit  [/ˈtrænzɪt/](cmd://Speak/_us_/transit) 

   *n.* 运输；经过；[天文]凌日；[天文]中天；[占星]凌；公共交通客运
   *vt.* 运送
   *vi.* 经过；[天文]（行星等天体）经过（另一天体、子午线）；[占星]（天体）经过（黄道十二宫之一、住宅或星图区域）

   时 态: transited, transiting, transits

   And to fund **public transit** at the same time   同时为公共交通提供资金 

   **fund** [ /fʌnd/](cmd://Speak/_us_/fund)  *n.* 基金，专款  现款；资金       *vt.* 为…提供资金，给…拨款   

5. **comprise**  [ /kəmˈpraɪz/](cmd://Speak/_us_/comprise)  vt. 包含；由…组成 

6. **ubiquitous**  [ /juːˈbɪkwɪtəs/](cmd://Speak/_us_/ubiquitous)   *adj.* <正>普遍存在的;无处不在的 

   We were **plagued** by the **ubiquitous** **mosquito**.  我们被无处不在的蚊子所困扰 

   **plague**  [ /pleɪɡ/](cmd://Speak/_us_/plague)  *n.* 瘟疫  *vt.* 使染瘟疫
   ...
   **mosquito**  [ /məˈskiːtoʊ/](cmd://Speak/_us_/mosquito)  蚊子

   **teem** [ /tiːm/](cmd://Speak/_us_/teem)  *vi.* 充满, 到处都是, 有很多  (指水、雨等)暴降, 倾注 

​		If something seems to be everywhere, we say it's ubiquitous.  如果有什么东西似乎无处不在，我们就说它		无处不在

7.  pilot  [ /ˈpaɪlət/](cmd://Speak/_us_/pilot)   project 实验计划 

   1. n. 领航员；飞行员
   2. adj. 试点的
   3. v. 驾驶；领航；试用 

8. **momentum**  [/moʊˈmentəm/](cmd://Speak/_us_/momentum)  n. 动力；动量；冲力；势头 

   **conservation**  [ /ˌkɑːnsərˈveɪʃn/](cmd://Speak/_us_/conservation)  *n.* 保存, 保护, 避免浪费  对自然环境的保护 

   1. 生物多样性保护：保护野生动植物及其栖息地，维护生态系统平衡，促进可持续发展。
   2. 自然资源保护：保护自然资源，如水资源、森林、土壤、矿物等，防止资源过度开采和浪费。
   3. 文化遗产保护：保护历史建筑、文物、遗址等文化遗产，维护文化多样性，传承人类文明。
   4. 能源保护：鼓励节约能源，开发清洁能源，减少对化石燃料的依赖，降低碳排放。
   5. 社区保护：保护社区环境和居民健康，加强社区发展和城市规划，提高居民生活质量。
   6. 语言保护：保护濒危语言，维护语言多样性，传承文化传统。

   总之，"conservation" 这个词在各种领域都有广泛的应用，可以用来指代对自然、文化、社区、资源等方面的保护和维护。

   *nature conservation* 自然保护；自然保育

   *momentum conservation* 动量守恒 

   **另外，对比conversation [ /ˌkɑnvɚ'seʃən/]() 这个词，别混淆了！！！**

9.  **preliminary**  [ /prɪˈlɪmɪnɛri/](cmd://Speak/_us_/preliminary)   *adj.* 初步的, 预备的, 开端的  *n.* 准备工作, 初步行动

   *preliminary study* 初步研究

   *preliminary analysis* 初步分析 

10.  **benchmark**  [ /'bɛntʃmɑrk/](cmd://Speak/_us_/benchmark) 
...
11. **fabric**  [ /ˈfæbrɪk/](cmd://Speak/_us_/fabric)  *n.* 织物, 布  构造, 组织 

    *knit fabric* 织物，针织布   [/nɪt/](cmd://Speak/_us_/knit) 

12. **leap**  [ /liːp/](cmd://Speak/_us_/leap) 

    1. vi. 跳，跳跃
    2. n. 跳跃；飞跃
    3. vt. 跳跃，跳过；使跃过 

    All growth is a leap in the dark, a spontaneous unpremeditated act without the benefit of experience  所有的成长都是黑暗中的飞跃，是没有经验的自发的无预谋行为

13. **homegrown**  [ /ˈhomˈɡron/](cmd://Speak/_us_/homegrown)  *adj.* (蔬菜等)本地出产[种植]  (蔬菜等)自己园子里种植的 

    *[homegrown food](dic://homegrown food)* 自家种的食品; 自家种的食物; 

    *[homegrown company](dic://homegrown company)* 本土公司 

14. respondent [ /rɪˈspɑːndənt/](cmd://Speak/_us_/respondent)   受访者

    The survey **respondents** were **quizzed** about their emotional wellbeing  **受访者**被问及他们的情绪健康状况 

    quiz [ /kwɪz/]  *vt 盘问*

    **wellbeing**  *n.* 健康；幸福 

15. **dereference**  [ /ˌdi'rɛfrəns/](cmd://Speak/_us_/dereference)  间接引用

    **dereference operator**: 运算子；解参考运算子；解参考算符；解引用操作符 

     The NULL pointer dereference is a common programming error that can lead to crashes and security vulnerabilities  空指针解引用是常见的编程错误，可能导致崩溃和安全漏洞 

    **vulnerability**  [/ˌvʌlnərəˈbɪləti/](cmd://Speak/_us_/vulnerability)  *n.* 弱点,攻击 

    *[vulnerability scanning](dic://vulnerability scanning)* 漏洞扫描 

    *[program vulnerabilities](dic://program vulnerabilities)* 程序漏洞 

16. **precipitate** [ /prɪˈsɪpɪteɪt/](cmd://Speak/_us_/precipitate)  *n.* 〈化〉沉淀物；析出物；冷凝物  *vt.* (突如其来地)使发生；促成  *vi.* 沉淀，淀析；凝结  *adj.* (指行动)急促的，迅猛的 

    They made a precipitate decision.  他们作了一个轻率的决定 

    "precipitate" 是一个常见的英语单词，常用来描述突然发生的、意外的、不可预测的事情。其含义包括促成、加速、导致、诱发等。这个词在英语中的使用频率较高，特别是在科学、医学、政治等领域。

    以下是一些常见的使用场景：

    1. 化学：在化学领域，"precipitate" 通常用于描述一种物质从溶液中析出的过程，也就是沉淀反应。例如：The addition  [/əˈdɪʃn/](cmd://Speak/_us_/addition)  of the reagent caused a white precipitate to form in the solution.（加入试剂导致溶液中形成了白色沉淀。）
    2. 天气：在气象领域，"precipitate" 可以用来描述下雨、下雪等自然降水的现象。例如：The forecast calls for heavy precipitation in the area tomorrow.（天气预报称明天该地区将有大量降水。）
    3. 医学：在医学领域，"precipitate" 通常用来描述某种事件或情况突然发生的过程。例如：The patient's sudden deterioration in health precipitated a series of emergency medical interventions.（患者健康突然恶化导致了一系列紧急医疗干预。）
    4. 政治：在政治领域，"precipitate" 可以用来描述某个事件或行动引发的紧急情况或后果。例如：The president's announcement precipitated a wave of protests across the country.（总统的宣布引发了全国范围内的一波抗议。）

    总的来说，"precipitate" 是一个相对常见的英语单词，用法比较广泛，特别是在科学、医学、政治等领域。

 17. prune [ /pruːn/](cmd://Speak/_us_/prune)  *vt.* 修剪(树木等)  精简某事物；除去某事物多余的部分  *n.* 西梅脯，西梅干 

 18. **cellular**   [ /ˈseljələr/](cmd://Speak/_us_/cellular)   adj. 细胞的；多孔的；由细胞组成的  n. 移动电话；单元 

 19. **pivot** [ /ˈpɪvət/]( )   n. 枢轴；中心点；旋转运动   vt. 以…为中心旋转；把…置于枢轴上  vi. 在枢轴上转动；随…转移 

     *pivot point* 枢轴点，旋转点；支点，枢心；轴心点

     *pivot table* 数据透视表

     The mother is often the **pivot of family life**  母亲往往是家庭生活的**中心人物**  

     Now **pivot** as you **deliver** the **stroke**  当你发动攻击时要转身 

20. **truncate**  [ /ˈtrʌŋket/]( )  adj. 截短的；被删节的  vt. 把…截短；缩短；[物]使成平面 

    1. **Truncate Cache**: 缩减缓存；截断缓存；扩充缓存
    2. **truncate table**: 删除表中所有行；清空表中数据；删除旧记录
    3. **truncate search**: 截字查寻；善用截字
    4. **Truncate Partition**: 截断表分区；截断分区
    5. **Truncate toward Zero**: 数轴上向零的方向取整；趋零截尾
    6. **truncate table TABLE**: 清除表数据
    7. **truncate log**: 截断日志

21. **lingo**  [ /'lɪŋgo/]()  *n.* 听不懂的话(指方言、术语等); 隐语;外语  

    *[industry lingo]()* 行话；行业术话      
...
1. **synopsis** [ /sɪˈnɑːpsɪs/]()  *n.* 摘要,梗概  大纲 
   ...
   *lecturer synopsis* 讲师资历；讲师简介

2. **surge**   [ /sɜːrdʒ/]()  

   A ship surges at anchor  抛锚的船 随波涛起伏 

   The stock market surged today  今天股票上涨  

3. **realise**  [ /'rɪəlaɪz/](cmd://Speak/_us_/realise)  *vt.* 实现  了解;认识到  *vt. & vi.* 变卖;赚得 

   It is a country where you can realise your dreams  这是一个你能实现梦想的国度 

4. **harvester**  [ /'hɑrvɪstɚ/](cmd://Speak/_us_/harvester)  *n.* 收割庄稼的人;收割机 

5. **masquerade** [ /ˌmæskəˈred/]()   伪装物；掩饰  *vi.* 假装(是)，冒充 

   *[IP masquerading](dic://IP masquerading)* IP伪装 

6. redact  [/rɪˈdækt/]()    *vt.* 编辑,编写 

   Oh, I suppose I could redact the classified parts  不过我想我也可以把保密的部分和谐掉啦 

7. quantile   [/'kwɒntaɪl/]()  *n.* 分位数 

8. **heuristic**  [ /hjʊ'rɪstɪk/]()   *adj.* 启发式的 

   *heuristic algorithm* 启发式算法；探试算法 

   Loss aversion is one cognitive bias that arises from heuristics, problem-solving approaches based on previous experience and intuition rather than careful analysis. “损失厌恶”是一种来自于大脑快速判断的认知失调，我们解决问题的方式来源于从前的经验和直觉而不是仔细的分析

9. **gauge**  [ /ɡeɪdʒ/]()   *pressure gauge* 压力计，测压表 

10. scalar  [ /ˈskelɚ/](cmd://Speak/_us_/scalar)  

    And what are **vector**s? **Scalar**s? And what does this mean?  什么是向量？标量？这是什么意思 

11. puzzle  [ /ˈpʌzl/]() 

    The figures were puzzling as well as perturbing 

    **perturb**  [ /pɚ'tɝb/]()   *vt.* 使(某人)烦恼；不安 

    首先，"as well as"通常用于连接两个具有不同性质的项目，其中第二个项目作为第一个项目的补充或增强。例如，"He is a doctor, as well as a teacher"（他不仅是医生，还是教师）。在这个例子中，"as well as"用于强调第一个项目的重要性，并提供了第二个项目的额外信息。

    相比之下，"and"通常用于连接两个或多个相似或相关的项目，它们具有相同或类似的性质。例如，"I like apples and oranges"（我喜欢苹果和橙子）。在这个例子中，"and"用于连接两个相似的项目，并表达它们的并列关系。

12.  **removal** [/rɪ'muvl/](cmd://Speak/_us_/removal)  n. 移动；免职；排除；搬迁 

    *dust removal* 除尘 

    The factory announced its removal to another town  这家工厂宣布迁往另一座城市 

13.  **verifiable**  [ /ˈvɛrəfaɪəbl/]()   *adj.* 能作证的,能证实的 

    Instead, the Russian strategy is to destroy the very idea of an objective, verifiable set of facts.  相反，俄罗斯的策略是破坏客观的、可验证的事实 

14. **fingerprint**  [ /ˈfɪŋɡərprɪnt/]() *n.* 指纹  

15. **versatile**  [ /ˈvɜːrsətl/]()   *adj.* 有多种学问、技能或职业的；多才多艺的  (指工具、机器等)多用途的，多功能的 

    *versatile person* 通才 

    The versatile worker was assigned to many different jobs  这个多才多艺的工人被分配了许多不同工作 

16. dial [/ˈdaɪəl/]()   *vt. & vi.* 打电话，拨电话号码  *n.* 钟(表)面；标度盘；拨号盘 

    Do you often **dial** home  你常给家里**打电话**吗  

    Eat more vegetables. **Dial back** the fats  多吃蔬菜。**减少**脂肪 

    Steroids can help **dial down** the immune system.  类固醇能帮助**减低**免疫系统反应 

17. **strive**  [ /straɪv/]()   vi. 努力；奋斗；抗争 
...
18. **tempest**  [ /ˈtɛmpɪst/]() 
    ...
    The tempest forced the ship onto the rocks.  [/rɑːk/]() 暴风雨迫使这这艘船撞上礁石 

19. **remainder**  [ /rɪˈmeɪndər/]()   *n.* 剩余物；残余部分 

    So, **for the remainder of my speech**, this is for the invisible kids.  因此，我演讲的剩余部分是为那些看不见的孩子们而准备的

    Sports drinks, which are often high in sugar and calories **made up most of the food and drink deals**, with soft drinks and fast food **filling out** the **remainder**.  高糖和卡路里的运动饮料通常占据了大部分食品和饮料的份额，软饮料和快餐填补了剩余 

    **deal**

    1. 交易、处理或安排事务。例如，"I need to deal with these emails before I can start working on the report"（我需要处理这些电子邮件，然后才能开始写报告）。
    2. 协商、讨论或与某人交往。例如，"I've been dealing with that supplier for years"（我已经与那个供应商打交道多年了）。
    3. 对待、处理或应对某种情况。例如，"How do you deal with stress?"（你如何处理压力？）。
    4. 发牌或分配牌。例如，在扑克牌游戏中，我们可以说 "Deal the cards"（发牌）。
    5. 购买、交易或交换商品或服务。例如，"I got a good deal on this car"（我在这辆车上得了个好交易）。

    **Dozens** of smaller **firms** make up the remainder of the market.  几十家较小的公司瓜分了剩下的市场 

    **"make up"** 是一个常用的短语，可以用在多种场景中。以下是其中一些最常见的用法：

    1. 组成或构成某物。例如，"Water makes up 60% of the human body"（水构成人体的60%）。
    2. 编造或虚构某事物。例如，"She made up a story to explain her absence"（她编造了一个故事来解释她的缺席）。
    3. 化妆或打扮。例如，"She spent an hour making herself up for the party"（她花了一个小时打扮自己去参加聚会）。
    4. 弥补或弥合差距或分歧。例如，"We need to make up after our argument"（我们需要在争吵后和解）。
    5. 做出决定或选择。例如，"I'll make up my mind after I've heard all the options"（在听取所有选项后，我会做出决定）。

20. **association**  [/əˌsoʊsiˈeɪʃn/]()   *n.* 协会, 社团  联合, 结合, 交往 

    ***trade association*** 贸易协会；同业公会 

    *association with* 与…的交往；与…联合

21. **explanatory** [ /ɪkˈsplænətɔːri/]()   *adj.* 解释的, 说明的 

    *explanatory note* 注释；附注 

    See explanatory notes at the foot of this page  参见本页下端的注解 

22. invocation     ***n.***    [ /ˌɪnvə'keʃən/]()

    **[invocation stack]()** 调用堆栈

    "invocation" 是一个较为正式的单词，通常用于宗教、政治和法律等场合。以下是其中一些最常用的场景：

    1. 宗教仪式中的**祈祷或祷告**。例如，在教堂或清真寺中，神职人员会进行宗教仪式的开场祈祷，这就是 "invocation"。
    2. 政治活动或仪式中的**开场致辞或祷词**。例如，在政治集会或纪念仪式中，会有人发表 "invocation"，祈求和平、和谐、团结等等。
    3. 法律程序中的**开场宣誓**。例如，在法庭上，法官或律师会在开庭前进行 "invocation"，宣誓信守法律、公正执法等等。
    4. 计算机编程中的**函数调用**。在计算机编程中，"invocation" 用于描述调用某个函数或程序的过程。

23. *equivalent circuit* 等效电路
...
24.  *engine hood* 发动机罩；引擎罩（盖）  [ /ˈendʒɪn/]() 

25. **correlation**  [ /ˌkɔrə'leʃən/]()   *n.* 相互的关系 

    *positive correlation* [化]正相关 

26. manipulate [/məˈnɪpjuleɪt/]()   被人拿捏

    Don't let yourself get manipulated this way  别让自己这么容易被左右 

    One tries to manipulate his dreams  一个人尝试操控他的梦 

    "manipulatory" 和 "manipulative" 都是形容词，但含义和用法有所不同。

    "manipulative" 常用于描述人或事物以欺骗或操纵他人为目的，通过巧妙或狡猾的手段来达到自己的目的。例如：a manipulative person（狡猾的人）、manipulative advertising（欺骗性广告）等。

    "manipulatory" 则较少使用，通常用于描述某个系统、设备或工具等具有操纵性或控制性，可用于控制或操作其他事物或系统。例如：a manipulatory robot（可控制的机器人）、a manipulatory software（可操控的软件）等。

    因此，"manipulative" 强调以欺骗或操纵他人为目的，而 "manipulatory" 则更偏向于描述具有操作或控制性质的事物。

27. schema  [/'skimə/]()   n. 图解；计划；模式；概要   

    "A schema is a blueprint for how a website should be structured and organized."（模式是网站应该如何构建和组织的蓝图。） 

    "The database schema defines the structure of a database system, including tables, fields, and relationships."（数据库模式定义了数据库系统的结构，包括表、字段和关系。）

    1. 数据库设计中的模式：在数据库中，"schema" 通常是用来描述数据库的结构和组织方式，包括各个表、字段、索引等元素之间的关系。
    2. Web 开发中的模板：在 Web 开发中，"schema" 可以用来描述 Web 应用程序的页面结构和布局，包括各个元素之间的关系、样式、内容等。
    3. 计算机编程中的数据结构：在计算机编程中，"schema" 也可用于描述数据结构，包括各个字段、类型、限制等元素之间的关系和约束。
    4. 心理学中的认知结构：在心理学中，"schema" 可以用来描述人们对世界的理解和认知结构，包括人们对概念、情境、事件等的认知方式和模式。
    5. XML 文件中的元素：在 XML 文件中，"schema" 可以用来描述 XML 文档的结构和组织方式，包括各个元素之间的关系和属性等。

    总之，"schema" 主要用于描述各种图形或模型的结构或架构，通常应用于数据库设计、Web 开发、计算机编程、心理学、XML 文件等领域。

28. **reassemble**   [ /ˌriə'sɛmbl/]()    *v.* 重新组装；重新集合 

    *[Protocol reassembling]()* 协议重组

    *[packet reassembling]()* 报文重组 

29.  **congestion**  [ /kən'dʒestʃən/]()  *n.* 拥挤;堵车 

    *traffic congestion* 通信量拥挤；信号拥挤

    *congestion control* 拥塞控制；拥挤控制

30.  **coordinator**  [/ko'ɔrdn,etɚ/]()   *n.* 协调者 

    **program coordinator**: 项目协调人

31. thereafter  *adv.* 此后; 在那之后 

    Thereafter they did not speak  此后他们就不再讲话了 

32. **contrast**   [ /ˈkɑːntræst/]()  
...
33. **validation**  [ /ˌvæli'deiʃən/]() 

    - "The credit card company needs to validate your account information before approving your application."（信用卡公司需要验证您的账户信息才能批准您的申请。）
    - "The researcher conducted experiments to validate her hypothesis."（研究人员进行实验来验证她的假设。）
    - "Before submitting the form, make sure to validate all the required fields."（在提交表格之前，请确保验证所有必填字段。）

    *verification and validation* [计]检验和确认

    "Verification" 和 "Validation" 这两个词都表示确认、验证或审查某些事情，但在软件工程和质量管理领域中，它们有着不同的含义和用法。

    "Verification" 通常用于确认一个系统或产品是否符合特定规范、标准或规则。它关注的是开发过程中是否正确地实现了所需的功能和特性。通常在软件开发的早期阶段就进行，例如在编写代码之前或在编码后的单元测试和集成测试中进行。

    "Validation" 则是用于确认一个系统或产品是否满足用户的实际需求和期望，以及是否能够正确地满足其预期的用途。它关注的是开发过程中是否开发了正确的功能和特性。通常在软件开发的后期阶段进行，例如在系统测试、验收测试和用户验收测试等过程中进行。

    简单来说，"Verification" 是确保开发的东西按照规格书和标准的要求正确完成，而 "Validation" 则是确保开发的东西能够满足用户的实际需求和期望。

    **verification**  [ /ˌvɛrɪfɪˈkeɪʃn/]()  

34.  **stratify**  [ /ˈstrætəfaɪ/]()   vt. 成层；分层；使形成阶层  vi. 分层；成层；阶层化
...
35. **delegate**  [ /ˈdɛlɪɡet/]()   *n.* 代表, 代表团成员  *vt.* 任命或委派…为代表  托付 

    Eight delegates voted against the motion  八名代表投票反对这一动议 

​		**motion**  [ /ˈmoʃn/]()   n. 动作；请求；手势；移动；意向  vi. 运动；打手势  vt. 运动；向…打手势 

36. **redundancy**  [ /rɪˈdʌndənsi/]()   *n.* 失业，被解雇，裁员，被裁减       多余，累赘，啰唆    复置装置，冗余
...
37. verbose  [/vɜːrˈbos/]()   adj. 冗长的；啰嗦的 

    "Redundancy" 更强调于事物的多余性，而 "Verbose" 更强调于语言表达的过度 

38. **reclaim**  [ /rɪˈklem/]()   *vt.*  

    *[baggage reclaim](dic://baggage reclaim)* 行李提取处；领取行李处 

    *[energy reclaim](dic://energy reclaim)* 能量回收 

    And reclaim that extra hour for yourself  为自己争取额外的时间 

    "Reclaim" 这个词的意思是“重新获得、重新拥有、回收、再利用、改造、治理、矫正等”，常用于以下场景：

    1. 环保领域：指对废弃物或污染物进行回收、再利用或治理，以减少对环境的影响。例如，回收废弃塑料瓶以制作新的塑料制品，治理受污染的土壤等。
    2. 自然资源领域：指重新获取、保护或管理自然资源。例如，重新开采废弃的矿山，保护濒危物种的栖息地等。
    3. 社会领域：指对被边缘化、弱势、失落或受伤害的人群进行帮助、改造或矫正。例如，帮助失业者重新就业，帮助戒毒者重新获得健康和社会地位等。
    4. 技术领域：指对旧的技术或设备进行改造或更新，以使其适应新的需求或应用。例如，将旧的计算机设备重新改造为服务器，将旧的建筑改造成创意空间等。
...
39.  **infer**  [ /ɪnˈfɜːr/]()    *vt.* 推断, 推知 
    ...
    From your smile I infer that you're pleased  [ /pliz/]() 从你的笑容, 我断定你很高兴  

40. **penetration**   [ /ˌpɛnɪ'treʃən/]()    *n.* 穿透;穿透能力;穿透深度  <军>突破;(空战中)深入敌方的飞行
...
1. **dedicated**  [ /'dɛdɪ'ketɪd/]()   *adj.* 专注的;献身的  <电脑>专用的 
   ...
   *dedicated channel* [计]专用信道
   ...
   dedicated network 专用网络

2. **badge** [ /bædʒ/]()   n. 徽章；标记；证章  vt. 授给…徽章 

   **Badge reader**是一种设备，用于读取身份证件上的信息并验证身份。它通常用于安全门禁系统、会议室门禁系统、考勤系统等场合

3. **encrypt**  [/ɪn'krɪpt/]()  *v.* 加密,将…译成密码 

   Cryptocurrency  加密货币  [ /ˈkɜːrənsi/]() 

4. **speculate**  [/ˈspɛkjuleɪt/]()    *vt. & vi.* 思索；猜测，推测  *vi.* 投机 

   Scientists speculate on the origin of the universe  科学家们猜测宇宙的起源 

5. **ordinal**  [ /'ɔrdənl/]()  *n.* 序数   比较  *adj.* 序数的 

   And fiftieth is the correct way to write the ordinal number.  而 fiftieth 才是序数词的正确写法 

6. **predominant**  [ /prɪˈdɑːmɪnənt/]()  *adj.* 占主导地位的, 显著的 

   *[predominant use]()* 主要用途   

   *[predominant frequency]()* 主频率; 优势频率;     

7. reintroduce  [ /'ri:,intrə'dju:s/]()   *vt.* 再引入,再提出 

   "reintroduce" 这个词通常表示将某个人、事物、想法、方法或产品重新引入到人们的视野中。 

8. variant [/'vɛrɪənt/]()  *n.* 变体；变种；变型  *adj.* 不同的；差别的；变异的 

   *[gene variant]()* 基因变种

9. **compatibility**  [ /kəmˌpætəˈbɪlətɪ/]()   *n.* 适合，一致;互换性； 通用性， 兼容性

10. **purge**  [ /pɜːrdʒ/]()   vi. 净化；通便  vt. 净化；清洗；通便  n. 泻药；净化 

    *air purge*   空气净化 

    And only **confession** can purge **sin**  只有忏悔才能净化罪孽 

    The purges are not a **concession** to the **opposition**  不过清洗并不代表对**反对派**的**让步** 

11. **yank**   [/jæŋk/]() vi. 猛地一拉  vt. 猛拉  n. 突然的猛拉 

    He yanked out a loose tooth  他猛拔出一颗松动了的牙 

12. **encapsulation**   [ /ɪnˌkæpsjuˈleɪʃn/]()   *n.* 封装

    封装通常指将数据和代码打包在一起，隐藏其内部实现，并仅暴露必要的接口和功能。封装可以提高代码的可维护性、可读性和安全性，以及减少代码之间的耦合性。在面向对象编程中，封装是一种重要的概念，通常通过访问修饰符（如public、private、protected）来实现。

    而"**Wrapper**" 通常指将一个对象或函数包装在另一个对象或函数中，以提供更高层次的抽象和功能。Wrapper的目的通常是扩展、定制或重载原始对象或函数的功能。Wrapper可以使用继承、接口、代理等技术来实现，也可以是一段代码或函数。

13. deprecate  [ /ˈdɛprəkeɪt/]()   *vt.* 不赞成, 反对  (**注意读音**)

14. **reside**  [/rɪˈzaɪd/]()   *vi.* 居住；定居 

    He has resided abroad for over ten years  他住在国外已10年多了 

    The **Constitution** has only three requirements, natural born citizen, at least 35 years old, 14 years **residing** in the United States.   宪法对总统只有三个要求，自然出生的公民，至少35岁，在美国居住有14年 

15. **ingest**  [ /ɪnˈdʒest/]()   *vt.* <正>吃；吞下  获取(某事物)   

    And I'm guessing that ingested means 'eaten'?  我猜“摄入”的意思就是“吃”吧 

16. **resilient**  [ /rɪˈzɪliənt/]()  *adj.* (指物体或材料)能复原的;有弹性的;有弹力的  (指人的性格)能迅速恢复或重新振作的;达观的;适应性强的  

    *[resilient material]()* 弹性材料 

17. **acyclic**  [ /e'saɪklɪk/]()   adj. 非循环的；非周期的 

    *acyclic graph* 非循环图；无圈图

    **cycle**  [/ˈsaɪkl/]()   n. 循环；周期；整套；自行车；一段时间  vt. 使循环；使轮转  vi. 骑自行车；循环；轮转 

    **cyclic**  [ /'saɪklɪk/]()   adj. 环的；循环的；周期的

    **cyclical**   [ /ˈsaɪklɪkl/]()   adj. 周期的，循环的 

    Directed acyclic graph GAG

18. **bearer**  [/'bɛrɚ/]() 

    1. 金融领域：在金融领域，"bearer" 通常指代持有某种证券或债券的人。例如，**Bearer Bonds**（持有人债券）是一种无记名债券，任何人都可以持有、交易和兑现。
    2. 移动通信：在移动通信领域，"bearer" 指代数据通信连接的承载方式。例如，4G移动网络通常使用 **LTE bearer（长期演进承载）**，来传输不同类型的数据。
    3. 物流和配送：在物流和配送领域，"bearer" 通常指代某个人或实体所持有的货物运输证明或提单。例如，海运货物通常需要提供"**bearer bill of lading"（提单），以证明持有人有权领取货物**。

    She is the bearer of good news.  她带来了好消息。 

    I'm sorry to be the bearer of bad tidings  很抱歉，我带来了坏消息 

19. **credential**  [ /krɪˈdenʃl/]() *n.* 外交使节所递的国书,信任状

    *[credentials]()* n. [管理] 证书；文凭  

    The third reason why managers use jargon is to establish their credentials  管理者使用行话的第三个原因是为了证明他们的资历 

20. **alias** [/'elɪəs/]() n. 别名，化名  

#### 018G

1. **fragment**  [/ˈfræɡmənt/]()  *n.* 分段

2. **outgoing** [ /ˈaʊtɡoɪŋ/]()  *adj.* 对人友好的;开朗的  即将离职的 

3. **warranty**  [/ˈwɔːrənti/]()  n. 担保；保证；授权；（正当）理由  

   *warranty period* 保修期；保证期间 

   *[warranty of merchantability]()* 商品性能保证 

   Our products are very reliable but we recommend you take out an extended warranty.  我们产品的质量非常可靠，但是我们建议你购买延长质保 

4. **avatar**  [/'ævətɑr/]()  阿凡达  

5. **merchant**  [ /ˈmɜːrtʃənt/]()  *n.* 商人  
   ...
   ***commission** merchant* n. 代销商，掮客    [ /kəˈmɪʃn/]()   *n.* 授权, 委托  委员会 

   *merchant fleet* 商船队

6. **glossary** [ /ˈɡlɑːsəri/]()  *n.* (书尾的)词汇表

7. **directive**  [ /dɪˈrektɪv/]()  *n.* 正式的指示，官方的指示；指令 

   This is a directive from the federal government  这一指令是由联邦政府直接下达 

8. **stash**  [/stæʃ/]()  *vt.* 贮藏；隐藏；藏匿 
...
10. solely  [ /ˈsoʊlli/]()  *adv.* 唯一地;仅仅;独一无二地

    *[Solely Owned]()* 港; 外资企业;

    *[solely state-owned]()* 国有独资 

    He is solely responsible  他独自负责 

11. diverse  [/daɪˈvɜːrs/]()  *adj.* 不同的, 多种多样的 

    *[diverse cultures]()* 多元文化; 不同的文化

    Commodities and art? You've got diverse interests.  商品和艺术？你有着多元化的兴趣。

    **commodity** *n.* 商品, 货物  

    futures 期货

12. **alternate**  [ /ˈɔːltərnet/]()  *adj.* 轮流的, 交替的  间隔的  代替的  *vt. & vi.* (使)交替, (使)轮换 

    *alternate current* 交流电  < == > *direct current* 直流；[电]直流电 
...
13. **symbolic**  [ /sɪmˈbɑːlɪk/]()  *adj.* 象征的, 象征性的 

    symbolic link 符号链接（软连接）

14. **offend**  [/əˈfend/]()   vt. 冒犯；使…不愉快  vi. 违反；进攻；引起不舒服 

    That sound offends my ear  那声音使我感到刺耳 

15. **dispute** [ /dɪˈspjuːt/]()   vt. 辩论；阻止；抗拒；怀疑  n. 辩论；争吵  vi. 争论 

    *settle dispute* 解决争端；解决争议 

16. **consul**  [ /ˈkɑːnsəl/]() *n.* 领事  

17. **spell**  [ /spɛl/]()  *vt. & vi.* 拼写，拼读 

18. **weird** [ /wɪrd/]()   *adj.* 怪诞的；神秘而可怕的；超然的 

    She has some weird ideas.

19. **whirl** [ /wɜːrl/]()  *vt. & vi.* (使)飞快移动，使旋转  *n.* 迅速的活动；混乱 

20. **exclusively**  [/ɪkˈskluːsɪv/]()   *adj.* 高级的，奢华的  专用的；独家的  *n.* 独家新闻，独家报道 

    *exclusive dealing* 独家销售；专卖；独家交易；独家经营 

    *exclusive interview* 独家采访 

    This was an **exclusive report** by CNN  这是CNN的独家报道

21. **governance**  [ /ˈɡʌvərnəns/]()  *n.* 统治;管理;治理;统治方式;管理方法 

    *corporate governance* 公司治理；企业管治，企业治理；公司管治

    *governance structure* 治理结构；统治结构；规制结构

    Primary-level governance in urban and rural areas was enhanced.  完善城乡基层治理 

22. **adhere**  [/ədˈhɪr/]()  *vi.* 黏附, 附着  坚持, 支持 

    1. 遵守规定或法律：在法律、规定或政策方面，"adhere" 可用于描述人们或组织遵守法律要求、规章制度或政府指导方针的行为。例如，"**adhere to traffic regulations**" 意味着遵守交通规则。

    2. 遵循准则或原则："adhere" 可用于描述人们在道德、伦理或价值观方面的行为。例如，"**adhere to ethical standards**" 意味着遵循道德准则。

       **ethical**  [ /'ɛθɪkl/]() adj. 道德的；伦理的

    3. 黏附或粘合："adhere" 还可以用于描述物体或材料之间的粘附或黏合。例如，"The sticker adheres to the surface" 意味着贴纸粘附在表面上。

    4. 遵循指示或指导："adhere" 也可以表示遵循指示或指导进行行动。例如，在工作环境中，"adhere to the supervisor's instructions" 意味着按照主管的指示行事。

    prescription medicine 处方药

    Over-the-counter drugs 非处方药

23.  **wrench**  [/rɛntʃ/]()   *vt.* (猛力地)扭，拧，扳  *n.* 一拧；一扳；猛扭，猛拉 

    ***socket wrench* [机械]套筒扳手** 

24. **quirk**  [ /kwɜːrk/]()  n. 怪癖；急转；借口 

    All men have their own quirks  人人都有他们自己的怪癖
...
1. **nucleus**  [/ˈnuːkliəs/]()  n. 核，核心；原子核 

   *atomic nucleus* n. [化]原子核

2. **abide** [ /əˈbaɪd/]()  *vt.* 容忍, 忍受  等候  *vi.* 逗留, 居住 

   Abide with me.  和我住在一起吧 

3. **majority** [ /məˈdʒɔːrəti/]() n. 多数；[律]成年 

   *majority of votes* 多数票；表决多数 

   The great majority approved  绝大多数同意了 

4. **observability**   [ /əb'zə:vəbiliti/]()  n. [数] 可观察性 

5. **pathetic**  [ /pəˈθɛtɪk/]()   adj. 可怜的，悲哀的；感伤的；乏味的 
   I think the way you're trying to rationalize your behavior is pathetic  你想把自己的行为合理化，真可悲

   **rationalize**  [/'ræʃnə'laɪz/]()   *vt.* 使合理化  *vt. & vi.* 为错误的或有害的行为找理由 

3. **consensus**  [/kənˈsensəs/]()   *n.* (意见等)一致, 一致同意 

   *reach a consensus* 达成共识

4. **increment**  [ /ˈɪŋkrəmənt/]()  *n.* 增长  递增

   "augment" 和 "increment" 都表示增加或增量的意思，但在使用上有一些区别：

   1. "Augment" 指的是通过添加、扩大或增加来增加某物的数量、规模或价值。它强调通过增加额外的元素或资源来扩展或丰富现有的事物。例如，"augment the team with new members" 意味着通过增加新成员来扩大团队的规模。
   2. "Increment" 则强调按递增或递增步骤增加某物的数量或价值。它通常表示在已有的基础上进行逐步增加或增量操作。例如，"increment the counter by one" 意味着将计数器逐步增加一个单位。

   总的来说，"augment" 更强调通过添加额外元素来增加整体数量或价值，而 "increment" 更侧重于逐步增加或递增操作。

5. **momentary**  [ /'moməntɛri/]()  *adj.* 瞬间的；短暂的；随时会发生的 

   *[momentary current]()* 瞬时电流

   *[momentary value]()* 瞬时值

6. **substitution**  [/ˌsʌbstɪˈtuːʃn/]()   *n.* 代替；代用；替换  代替物；代用品；替换物 

   *substitution method* 代入法；替换法 

7. **agile**  [ /ˈædʒl/]()  *adj.* 灵巧的，轻快的，活跃的 

   *agile manufacturing* 敏捷制造

   *agile development* 敏捷开发；敏捷式软体开发

   He was coordinated and agile, and he became adept in sports  由于协调性好，动作敏捷，他很快就成了运动高手 

   adept  [ /əˈdɛpt/]()  adj. 熟练的；擅长…的  n. 内行；能手

8. **notary**  [/'notəri/](\)  n. 公证人 

   You also find notaries no matter what country you're in  无论身处哪个国家都会有公证员 

9. **ransom**  [ /ˈrænsəm/]()   vt. 赎回，赎；勒索赎金；得赎金后释放；[宗]救赎  n. 赎金；赎身，赎回 

   *[a king's ransom]()* 一笔巨款

   In addition, the Qing Dynasty had to pay a huge ransom in cash  除此之外 清政府还签下巨额赔款 

10. signed integer 带符号整数

11. **headquarters**  [ /ˈhɛdˈkwɔrtɚz/]()     *n.* (机构, 企业等的)总部, 总店  司令部, 指挥部 

12. **familiarize**  [/fə'mɪlɪəraɪz/]()   *vt.* 使(某人)熟悉,使通晓 

    Speaking of priming, it's important that you familiarize yourself with the exam room   说到备考，熟悉考场是非常重要的。 

13. **prime**  [ /praɪm/]()  

    adj. 基本的；最好的；主要的  adv. 极好地 n. 初期；青年；全盛时期；精华 vt. 填装；使准备好 vi. 作准备

    *prime minister* 首相，总理 

    *prime number* 素数 

14. **defunct**  [ /dɪˈfʌŋkt/]()  adj. 非现存的；死的  n. 死者 

    *[defunct company]()* 已倒闭的公司

15. **premise**  [/ˈpremɪs/]()   vt. 引出，预先提出；作为…的前提  n. 前提；上述各项；房屋连地基  vi. 作出前提 

    We have a warrant to search the premises.  我们有搜索这栋宅邸的授权令。 

    Are the inferences valid? Does the conclusion follow the premises?  推断有效吗？结论与前提一致吗？ 

16. **emulate**   [ /ˈɛmjuleɪt/]()   *vt.* *【计算机科学】* 仿真，仿效  竞争  看齐

    *[Emulates forward]()* 向前看齐

    *[emulate simulation]()* 仿真模拟

    *[Simulink emulates]()* Simulink仿真

17. **concrete**  [ /ˈkɑːŋkriːt/]() 

    1. "Concrete" 作为名词，指的是一种用于建筑和构造的建材，通常由水泥、沙子、石子和水混合而成。它用于建造房屋、桥梁、道路等结构。例如：
       - "The workers **poured** the concrete for the foundation of the building."（翻译：工人们倒入混凝土以建造建筑物的基础。）[出处：实际情境]
    2. "Concrete" 作为形容词，意为具体的、实际的或明确的。它用于描述具体的事物、观念或想法。例如：
       - "We need to come up with concrete solutions to the problem."（翻译：我们需要提出具体的解决方案来解决这个问题。）[出处：商务会议]
       - "She has concrete evidence to support her claims."（翻译：她有确凿的证据来支持她的主张。）[出处：法庭辩论]
    3. "Concrete" 还可以作为动词使用，表示使具体化或实体化。例如：
       - "He struggled to concrete his abstract ideas into a **coherent** plan."（翻译：他努力将抽象的想法具体化为一个连贯的计划。）

#### 020G

1. **terminology**  [ /ˌtɝmɪ'nɑlədʒi/]()  *n.* 专门用语；术语；术语学
...
2. **specification** 
   ...
   3. 建筑规范（Building Specifications）
   4. 标准规范（Standard Specifications）
   5. 软件规范（Software Specifications）
...
4. **affinity**   [ /əˈfɪnəti/]()  n. 吸引力；姻亲关系；密切关系；类同 

   English has a close affinity to French.  英语同法语很相近 

   All the elements in the periodic table have a different affinity for electrons.   元素周期表中的所有元素对电子都有不同的亲和力。 

5. **semantic**  [/sɪ'mæntɪk/]()    adj. 语义的；语义学的 

6. **compliant**  [ /kəmˈplaɪənt/]()  *adj.* 遵从的,依从的,顺从的,屈从的 

   I don’t **respect** people who are too **compliant**.  我不尊重那些太顺从的人。 

7. **ideally**  [ /aɪ'diəli/]()   adv. 理想地；观念上地 

   *[Ideally offsite]()* 理想的隔离点  

   *[No offsite Data]()* 无异地数据备份

   Ideally,I would like to start at the beginning.  要是有可能,我们真想从头开始

8. **promiscuous**  [/prə'mɪskjuəs/]()  *adj.* 混杂的，杂乱的；（人）滥交的 

   *[Promiscuous life]()* 放荡生活  

   promiscuous mode 混杂模式

9. **caveat**  [/'kævɪ'at/]()   "caveat" 用于引起注意、警告或提醒 

   "caveat emptor" 意味着“买方自负风险” 

   "caveat investor" 意味着“投资者需谨慎” 

10. *[for the sake of convenience]()* 为了方便起见

    **Nevertheless**, students should not study merely **for the sake of** passing exams   但是，学生不应该仅仅为了通过考试而学习

    [ /ˌnɛvərðəˈlɛs/]()  *adv.* 仍然, 然而, 不过  *conj.* 尽管如此, 然而 

11. **opaque**  [/oˈpeɪk/]()   *adj.* 不透明的  难理解的, 晦涩的 

    *opaque glass* 不透明玻璃 

12. **pertinent**  [ /ˈpɜːrtnənt/]()  *adj.* 有关的; 中肯的; 恰当的 

    The second step is all about finding **pertinent information**  第二步就是寻找**相关信息** 

13. **recursive**  [ /rɪ'kɝsɪv/]()  

    递归方程可以用英语表示为 "recursive equation" 或 "recurrence relation" 

    回归（Regression）和递归（Recursion） 

    **equation** [ /ɪˈkweɪʒn/]()   n. 方程式，等式；相等；反应式 
...
18. **decentralize**  [ /ˌdiːˈsɛntrəlaɪz/]()  *vt.* 权力下放；将(权力等)自中央政府转到地方政府  n. 分散 
    ...
    **European** countries were trying to **decentralize** and **devolve**  欧洲国家尝试着分权和移交权力

​		**devolve**  [ /dɪ'vɑlv/]()  vi. 被移交；转让  vt. 转移；移交；使滚下；衰落

19. **counterpart**  [ /ˈkaʊntərpɑːrt/]()  *n.* 与对方地位相当的人; 副本

    It has no counterpart in the world  举世无双

20. **prefetch** [ /'pri:'fetʃ/]()  v. 预取     **Link prefetch**: 预加载
...
1. **bottleneck** [ /'bɑtlnɛk/]()   *n.* 瓶颈  瓶颈路段(常引起交通堵塞)  (尤指工商业发展的)瓶颈；阻碍；障碍 

   Roadworks are causing bottlenecks in the city centre  道路施工导致市中心交通阻塞 

2. bastion [ /ˈbæstʃən/]()  n.  堡垒

   *[bastion host]()* 堡垒机

3. **mandatory**  [ /'mændətɔri/]()  *adj.* 命令的;强制的;义务的 

   *mandatory requirement* 强制性要求；必须遵循的要求

4. **be bound to**  必然，必定 

   It's bound to rain soon.  不久就会下雨的  

   **I'm bound to succeed in my enterprise**  他在事业上一定会成功

5. **degrade**  vt. 使……丢脸；使……降级；使……降解；贬低  vi. 退化；降级，降低 

   *[degrading enzyme]()* 降解酶 **enzyme**  [ /ˈɛnzaɪm/]()  *n.* 酶

6. **vagrant**  [ /ˈveɡ rənt/]()  *n.* 流浪者，漂泊者  <律>无业游民；乞丐；无赖  *adj.* 流浪的，漂泊不定的

   A vagrant is everywhere at home  流浪者四海为家

   Police seek help in identifying mystery [/ˈmɪstəri/]()  vagrant.  警方寻求协助指认神秘流浪汉 

7. **hexadecimal** [ /ˌhɛksə'dɛsəml/]() *n.,adj.* 十六进制(的)  

   **octonary** [ /'ɑktə,nɛri/]()  n. adj. 八进制的 

   **binary** [/'baɪnəri/]() n. adj. 二进制的 

   **decimal** [/ˈdɛsəml/]()  *adj.* 十进位的, 小数的  ***n.* 小数**  

8. **clutter**  [ /ˈklʌtər/]()  n. 杂乱，混乱  vt. 使凌乱；胡乱地填满 

   Her belongings clutter up my bedroom  她的东西乱七八糟堆满在我臥室里 

   The clutter of the similar photos is gone  类似照片的杂乱已经消失了 

9. **rancher**  [/ˈræntʃər/]()  n. 农场主；大农场工人 

10. relevance  [ /ˈreləvəns/]()  *n.* 关联；切题 

    Finally, I would appreciate it if you could grant me an interview so that I could explain in more details in person the relevance of my educational background and working experiences  最后，如果您能给我一个面试机会，以便我可以亲自更详细地解释我的教育背景和工作经验的相关性，我将不胜感激。 

11. **coaxial**  [/ko'æksɪəl/]()   *adj.* 同轴的,共轴的

12. **latter**  [ /ˈlætər/]()  adj. 后者的；较后的；近来的；后面的

    The **former** is a scale shift. The **latter** is a **perceptual** shift  前者是转变比例， 后者是改变看法 

13. intent  [ /ɪnˈtɛnt/]()  n. 意图；目的；含义  adj. 专心的；急切的；坚决的  

    *letter of intent* n. 意向书 

    *intent on* 专心致志于  

    |   vocu    |                       translate                        |                      sample of sentence                      |
    | :-------: | :----------------------------------------------------: | :----------------------------------------------------------: |
    |  intent   |            法律用词，常指某人怀有歹意而犯罪            | It was not his intent to hurt anyone 他的本意并不是想伤害谁  |
    | intention | 普通用词，指某人内心产生的想做某事的想法，侧重内心活动 | It wasn't my intention to exclude her from the list - I just forgot her 我并不是故意将她排除在名单之外——只是把她忘了而已 |
    |  design   |         多用复数形式，含贬义多指行为不轨的意图         | I think Alan has designs on your job/wife! 我觉得艾伦对你的工作／妻子有不良企图 |

14. **advertise**  [ /ˈædvərtaɪz/]()  *vt.* 公布, 宣传  *vt. & vi.* (给…)做广告宣传  做广告 

    It pays to advertise  做广告是值得的 

15. **imagine**  [ /ɪˈmædʒɪn/]()  *vt.* 想象, 设想  料想, 猜想 

    You can imagine how the idea would torment him.  你们可以想象得到，知道这一点会折磨他到什么程度

    **torment**  [/ˈtɔːrmɛnt/]()  vt. 折磨，使痛苦；纠缠，作弄  n. 痛苦，苦恼；痛苦的根源 

16. **aggregate** [ /ˈæɡrɪɡət/]()  [ /ˈæɡrɪɡɪt/]()  adj.  聚集的   n. 总数；合计  *vt.* 总计达… 

    But in the aggregate, trade does improve the global standard of living  但总的来说，贸易确实提高了全球的生活水平

    aggregation switch  汇聚交换机

    core switch

17. "vendor"（供应商）一词通常用来指代提供或销售软件、库、框架、组件或其他技术产品的公司、团队或个人。供应商提供的产品可以包括操作系统、开发工具、数据库管理系统、应用程序接口（API）等。"vendor"还可以指代为特定技术或平台提供支持和服务的组织或个人。在编程领域，与供应商相关的概念还包括供应商锁定（vendor lock-in），即使用某个供应商的产品或技术后难以轻易切换到其他供应商。

18. **synch**  [ /sɪŋk/]()  n. 同时，同步  *[synch precision]()*  [/prɪˈsɪʒn/]() *n.* 精确度, 准确(性) 同步精度

19. grit [ /ɡrɪt/]()  *n.* 砂砾；勇气，决心；粗砂岩  *v.* 在……上铺砂砾；咬紧牙关；吱嘎吱嘎地移动 

    400 grit paper.  细度为400的砂纸 

    *steel grit* 钢砂；钢丸；钢粒 

    **It was grit. Grit is passion and perseverance for very long-term goals. Grit is having stamina**  是耐力，耐力是对长期目标的热情和坚持，耐力就是持久力

    Hard work, determination, and perseverance always win out  努力 决心 坚持 就是成功三秘诀 

    **perseverance** [ /ˌpɜːrsəˈvɪrəns/]()  n. 坚持不懈；不屈不挠 

    **stamina** [ /'stæmɪnə/]()  *n.* 耐力，持久力，毅力 

20. **opinionated**  [ /əˈpɪnjənetɪd/]()  *adj.* <贬>固执己见的,武断的 

    He is the most opinionated man I know  他是我所认识的最固执己见的人

    I'm 2 minutes late  我迟到了2分钟 

21. **reconciliation**  [ /ˌrekənsɪliˈeʃn/]()   *n.* 和解，调和；一致；勉强接受  (争吵等的)止息；和解 

    They informed him that they wished *[wɪʃt]*  reconciliation  他们告诉他, 他们愿意和解

22. **accommodate**  [ /əˈkɑːmədet/]()  *vt.* 容纳  向…提供住处  

    Consider my coffee table, it increases in size to accommodate 10  以我的咖啡桌为例，它的大小可以增加到供十人围坐

23. **propagate** [/ˈprɑːpəɡet/]()  *vt. & vi.* 繁衍，增殖  *vt.* 传播；宣传，普及 
...
24. High Availability Considerations  高可用性注意事项
...
4. **facilitate**  [ /fəˈsɪlɪteɪt/]()  *vt.* 使便利, 减轻…的困难 
...
7. **entertain**   [ /ˌɛntərˈten/]()   *vt. & vi.* 款待, 招待  *vt.* 使欢乐, 使娱乐 
   ...
   When you are in town you entertain yourself  当你进城的时候你自娱自乐
...
9. **definitive** [ /dɪˈfɪnətɪv/]()  *adj.* 决定性的, 明确的, 权威性的, 不能或不必改变的
   ...
   *definitive edition* 最终版
   ...
   We got a definitive victory  我们取得了决定性的胜利

10. also known as ==> 又叫做 ==>  AKA

11. **scenario**  [ /sɪˈnɛrioʊ/]()  n. 情节；剧本；方案 

    *scenario analysis* 情境分析 

    This scenario is the most common scenario  这种情景是最常见的情况
...
14. **anew** [ /əˈnju]()  *adv.* 再, 重新
    ...
    **illumination**  [/ɪ'lʊmə'neʃən/]()  *n.* 照明   

15. **Jewish**  [/'dʒʊɪʃ/]()  *adj.* 犹太人的;犹太教徒的 

16. **abbreviation**   [ /əˌbriːviˈeʃn/]() *n.* 缩写; 缩写词 

    *[in the context of]()* 在…情况下；在…背景下

17. **refactoring** [/ri fæk tə riŋ/]() *n. 重构；重整*  **software refactoring** 

18. consist  [ /kənˈsɪst/]()   *vi.* 组成, 构成
...
21. **amateur**  [/ˈæmətər/]()   [/ˈæmɪtʃər/]()    *adj.* 业余的, 非职业的  *n.* 业余爱好者

22. stagger   [ /ˈstæɡər/]()

    1. 行走或移动时踉跄或摇晃：

       He staggered and nearly fell after tripping on the uneven pavement. （他踉跄了一下，差点在不平整的人行道上摔倒。）

    2. 时间或顺序的错开或错位：

       The classes are staggered throughout the day to accommodate different schedules. （为了适应不同的时间安排，这些课程在一天中错开了。）

    3. 使吃惊、震惊或困惑：

       The news of his sudden resignation staggered everyone in the office. （他突然辞职的消息让办公室里的每个人都感到震惊。）

    4. 分阶段进行或分批处理：

       The construction project will be staggered over several months to minimize disruptions. （为了减少干扰，这个建筑项目将分阶段进行数个月。）

    The notion hung [ /hʌŋ/]() (v. 悬挂；垂落（hang的过去式和过去分词） )in his mind for months  这个念头在他心里有几个月了

23. *[Somewhat Thicker](d)* 有点厚 

    **somewhat**  *adv.* 稍微, 有点, 达到某种程度 

24. **vibration**  [ /vaɪ'breʃən/]()  *n.* 震动

25. **scandal** [ /ˈskændl/]()  *n.* 丑事，丑闻
...
30. **stretch**  [/strɛtʃ/]()  vt. 伸展,张开  vi. 伸展 adj. 可伸缩的 n. 伸展，延伸 **拉伸**
    ...
    Why do athletes always stretch or jog before practice   为什么运动员在训练前总是伸展或慢跑

31. **envelope** [ /ˈɛnvəlop/ ]() 信封

32. **multidimensional**  [ /ˌmʌltɪdɪˈmɛnʃənəl/]()  *adj.* 多面的,多维的

    *multidimensional array* 多维数组

33. **expiration**  [ /ˌɛkspə'reʃən/]()   *n.* 满期，届期；截止，告终  呼气，吐气；(气的)呼出；呼出物；嘘出的声音

    ***expiration date* 截止日期** 

34. **originate**  [/əˈrɪdʒɪneɪt/]()  *vi.* 起源于，来自，产生  *vt.* 创造，创始，开创；发明

35. **substantial** [ /səbˈstænʃl/]()   *adj.* 坚固的；结实的  大量的，可观的
...
36. **mitigate**  [ /ˈmɪtɪɡet/]()   vt. 使缓和，使减轻  vi. 减轻，缓和下来 
    ...
    **endeavour**  [ /ɛnˈdɛvɚ/]()   *v.n.* 〈英〉尽力,竭力 

    **distress**  [ /dɪˈstres/]()   *n.* 悲痛, 痛苦, 忧伤, 苦恼  贫困, 窘迫 

37. **proportion**  [ /prəˈpɔːrʃn/]()  *n.* 均衡；相称，协调

    *direct proportion* n. 正比；正比例 

    *geometric proportion* 等比

    **geometric**  [ /ˌdʒiə'mɛtrɪk/]()   *adj.* 几何(学)的 成几何级数增加的

38. I can deactivate if you say 'you are satisfied with your care'   只要你对我的照顾表示满意，我就可以结束工作了

39. **tenancy**  [/'tɛnənsi/]()  *n.* 租用, 租赁 

40.  **proliferation**  [ /prə-,lifə'reʃən/]()  *n.* 增殖,分芽繁殖
